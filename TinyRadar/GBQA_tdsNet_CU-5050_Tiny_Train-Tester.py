...
model.load_weights('./Models/GBQA_tdsNet_CU-5050-Prune_Tiny.h5') 
...
Test_Embeddings = testing_model.predict(X_train)
...
np.savez_compressed('./Embeddings/GBQA_tdsNet_CU-5050-Prune-Train_Tiny.npz',Test_Embeddings)