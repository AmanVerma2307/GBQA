...
def main():
    ...
    for s_id, s_folder in enumerate(np.sort(os.listdir(data_folder))):

        s_folder = data_folder+'/'+s_folder
        print('=========================================')
        ...
        for g_id, g_folder in enumerate(np.sort(os.listdir(s_folder))):
            ...
            for instance_id, instance in enumerate(np.sort(os.listdir(g_folder))):
                ...
                if(instance_id <= 5): # Saving First 6 Instances as Training Instances
    ...
    ##### Data Saving
    np.savez_compressed('./Datasets/HandLogin/DGBQA-Seen/X_train_DGBQA_Seen_HandLogin.npz',X_train)
    np.savez_compressed('./Datasets/HandLogin/DGBQA-Seen/y_train_DGBQA_Seen_HandLogin.npz',y_train)
    np.savez_compressed('./Datasets/HandLogin/DGBQA-Seen/y_train_id_DGBQA_Seen_HandLogin.npz',y_train_id)
    np.savez_compressed('./Datasets/HandLogin/DGBQA-Seen/X_dev_DGBQA_Seen_HandLogin.npz',X_dev)
    np.savez_compressed('./Datasets/HandLogin/DGBQA-Seen/y_dev_DGBQA_Seen_HandLogin.npz',y_dev) 
    np.savez_compressed('./Datasets/HandLogin/DGBQA-Seen/y_dev_id_DGBQA_Seen_HandLogin.npz',y_dev_id)
