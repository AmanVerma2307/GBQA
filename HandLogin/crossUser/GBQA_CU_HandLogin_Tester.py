...
cm_plot_labels = ['Compass','Piano','Push','Flipping Fist']
...
for idx,color_index in zip(list(np.arange(4)),["#1f77b4", "#ff7f0e", "#2ca02c", "#d62728"]):
    plt.scatter(tsne_X_dev[y_dev == idx, 0],tsne_X_dev[y_dev == idx, 1],s=55,color=color_index,edgecolors='k',marker='h')
plt.legend(['Compass','Piano','Push','Flipping Fist'],loc='best',prop={'size': 12})
