...
model.load_weights('./Models/GBQA_tdsNet_CU-5050-Full_Soli.h5') 
...
print(model.evaluate(X_dev,y_dev,batch_size=6))
g_hgr = model.predict(X_dev,batch_size=6)
...
##### Saving Results
result_file = open('./Result Files/GBQA_tdsNet_CU-5050-Full_Soli.txt','w')
...
Test_Embeddings = testing_model.predict(X_dev,batch_size=4)
Train_Embeddings = testing_model.predict(X_train,batch_size=4)
...
np.savez_compressed('./Embeddings/GBQA_tdsNet_CU-5050-Full_Soli.npz',Test_Embeddings)
...
np.savez_compressed('./Embeddings/GBQA_tdsNet_CU-5050-Full-Train_Soli.npz',Train_Embeddings)
