...
print(model.evaluate(X_dev,(y_dev,y_dev_id),batch_size=8))
g_hgr, _ = model.predict(X_dev,batch_size=8)
...
Test_Embeddings = testing_model.predict(X_dev,batch_size=8)
