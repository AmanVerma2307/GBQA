...
model.load_weights('./Models/GBQA_msRes3D-MViT_CU-5050_Soli.h5') 
...
##### Saving Results
result_file = open('./Result Files/GBQA_msRes3D-MViT_CU-5050_Soli.txt','w')
...
#### Heatmap Plotting
filepath='./Graphs/Softmax Heatmap/GBQA_msRes3D-MViT_CU-5050_Soli.png'
...
np.savez_compressed('./Embeddings/GBQA_msRes3D-MViT_CU-5050_Soli.npz',Test_Embeddings)
...
plt.savefig('./Graphs/tSNE/GBQA_msRes3D-MViT_CU-5050_Soli.png')
