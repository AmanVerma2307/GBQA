...
def dataset_iterator(data_path,
    ...
    if(test_set == False):
        ...
        for gesture_id in [1,2,4]: # Iterating over Gestures
            print('++++++++++++++++++++++++++++++++++++++++++++++++++')
...
if __name__ == "__main__":
    ...
    X_train, y_train, y_train_id = dataset_iterator(directory,
                                        ...
                                        10,
                                        False)
    np.savez_compressed('./Datasets/SCUT-DHGA/GBQA/y_train_GBQA-CU-5050-Prune_SCUT.npz',y_train)
    np.savez_compressed('./Datasets/SCUT-DHGA/GBQA/y_train_id_GBQA-CU-5050-Prune_SCUT.npz',y_train_id)
    ...
    X_dev, y_dev, y_dev_id = dataset_iterator(directory,
                                        ...
                                        10,
                                        True)
    np.savez_compressed('./Datasets/SCUT-DHGA/GBQA/y_dev_GBQA-CU-5050-Prune_SCUT.npz',y_dev)
    np.savez_compressed('./Datasets/SCUT-DHGA/GBQA/y_dev_id_GBQA-CU-5050-Prune_SCUT.npz',y_dev_id)
    #print(X_dev,y_dev)
